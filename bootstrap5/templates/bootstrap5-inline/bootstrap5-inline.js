...
import './bootstrap5-inline.html'

Template['quickForm_bootstrap5-inline'].helpers({
...
Template['afFormGroup_bootstrap5-inline'].helpers({
  afFieldInputAtts: function () {
    const atts = Object.assign({}, this.afFieldInputAtts)
    // Use the same templates as those defined for bootstrap5 template.
    atts.template = 'bootstrap5'
    return atts
  }
})
